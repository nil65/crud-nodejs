    ...
    if (confirmation === true) {
        ...
        $.ajax({
            ...
            if (response.msg == 'success') {
                console.log('running');
                //$(this).attr('rel').closest('tr').remove();
...
function editUser(event) {
    ...
    $('#addUser fieldset div').html('<button id="btnUpdateUser" rel=' + thisUserId + '>Update</button><button id="btnUpdateCancel" rel=" ">Cancel</button>');
...
$(document).on("click", '#btnUpdateUser', function(event) {
    ...
    var confirmation = confirm('Are you sure you want to Cancel this update?');
